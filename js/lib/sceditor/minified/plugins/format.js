...
function(a) {
  ...
  a.sceditor.plugins.format = function() {
    ...
    d.init = function() {
      var b = this.opts,
      d = b.paragraphformat;
      a.sceditor.plugins.bbcode && b.plugins && b.plugins.indexOf("bbcode") > -1 || (d && (d.tags && (e = d.tags), d.excludeTags && a.each(d.excludeTags,
      function(a, b) {
        delete e[b]
    ...
    c = function(c) {
      ...
      function(c, e) {
        a('<a class="sceditor-option" href="#">' + (e.name || e) + "</a>").click(function() {
          return d.closeDropDown(!0),
          e.exec ? e.exec(d) : b(d, c),
          !1
        }).appendTo(f)
      }),
