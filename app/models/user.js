define(["ember", "ember-data", "app/helpers/utilities", "app/helpers/alert", "md5", "app/models/model"], 
  function(Ember, DS, Utilities, Alert, md5, FBModel) {
  var User = FBModel.extend({
    name: DS.attr('string'),
