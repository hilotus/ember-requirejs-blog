define(["ember", "app/helpers/alert", "app/helpers/persistence"], function(Ember, Alert, Persistence){
  return Ember.ArrayController.extend({
    ...
    paginate: function() {
      ...
      var page = this.get('page'), pages = this.get('pages'), per_page = this.get('per_page'), _this = this;
    ...
    actions: {
      ...
      delete: function(post) {
        ...
        Alert.warn(Ember.I18n.t("posts.destroy.prompt"), Ember.I18n.t("posts.destroy.body"), 
          ...
          if (i == 2) { // ok
            Alert.operating(Ember.I18n.t("posts.destroying"))
            Persistence.deleteRecord(controller.store, 'post', post, function(){
